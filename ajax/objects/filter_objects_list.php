        ...
        <table class="table">
            ...
            <? foreach ($arResult["ELEMENTS"] as $id => $item): ?>
                <tr>
                    ...
                    <td><?= $item['CAPACITY'] ?></td>
                    <td>
                        <a href="/admin/objects_list/?edit=Y&amp;CODE=<?= $id ?>" class="btn-edit">
                    ...
                    <td>
                        <a class="btn-remove"
                           ...
                           onClick="return confirm('<? echo CUtil::JSEscape(str_replace("#ELEMENT_NAME#", $item['NAME'], "Вы действительно хотите удалить элемент #ELEMENT_NAME#?")) ?>')"
                        >
