...
$APPLICATION->SetTitle("Быстрая бронь");

$arObjects = [];
$arObjects = $arResult['OBJECTS'];
    ...
    <div class="tabs-content">
        <div class="tabs-content_item active" data-id="2">
            <form name="iblock_add" action="<?= POST_FORM_ACTION_URI ?>" class="lk-booking-form" method="post"
                ...
                <? endif ?>
                <? if (isset($arResult['MANAGER_LOCATIONS']) && !empty($arResult['MANAGER_LOCATIONS'])): ?>
                        ...
                        <div class="input-group">
                            ...
                            <div class="select-block select-block--md" id="category-filter-block">
                                ...
                                <div class="custom-select" id="object-category-filter">
                                    ...
                                    <div class="custom-select_body">
                                        ...
                                        <? endforeach; ?>
                                        <!--<div class="custom-select_columns">
                                            <div class="custom-select_column">
                                                <div class="custom-select_item">Локализация 1</div>
                                                <div class="custom-select_item">Локализация 2</div>
                                                <div class="custom-select_item">Локализация 1</div>
                                                <div class="custom-select_item">Локализация 2</div>
                                            </div>
                                            <div class="custom-select_column">
                            ...
                            <div class="select-block">
                                ...
                                <div class="radio-group" id="filter-period-block">
                                    ...
                                    <div class="radio">
                                        <input type="radio" id="filter-period-day" data-period="day"
                                               name="filter-period">
                    ...
                    <? else: ?>
                        <div class="form-block">
                            ...
                            <div class="radio-list" id="objects-list">
                                <? if (count($arObjects) == 1): ?>
                                    <div class="radio">
                                        <input type="radio" id="radio_<?= $arObjects[0]['ID'] ?>"
                                               name="PROPERTY[21][0][VALUE]"
                                               value="<?= $arObjects[0]['ID'] ?>"
                                               data-time-interval="<?= $arObjects[0]['TIME_INTERVAL']['TYPE'] ?>"
                                               data-time-value="<?= $arObjects[0]['TIME_INTERVAL']['VALUE'] ?>"
                                               data-time-limit-value="<?= $arObjects[0]['TIME_LIMIT'] ?>"
                                               data-car-possibility-value="<?= $arObjects[0]['CAR_POSSIBILITY'] ?>"
                                               data-car-capacity-value="<?= $arObjects[0]['CAR_CAPACITY'] ?>"
                                               checked
                                        >
                                        <label for="radio_<?= $arObjects[0]['ID'] ?>">
                                            <div class="radio_text"><?= $arObjects[0]['NAME'] ?></div>
                                        </label>
                ...
                <div id="booking-params" style="display: none">
                                    ...
                                    <div class="m-input-dates m-input-dates--md">
                                        ...
                                        <!--<div class="m-input-date-block">
                                            <label for="" class="input-label">Время заезда <span
                                                        class="color-red">*</span></label>
                                            <input type="text" name="PROPERTY[13][0]" class="input-time" size="30" required>
                                        </div>
                                        <div class="m-input-date-block">
                                            <label for="" class="input-label">Время выезда <span
                                                        class="color-red">*</span></label>
                                            <input type="text" name="PROPERTY[14][0]" class="input-time" size="30" required
                                                   readonly>
                                        </div>-->
                    ...
                    <div class="group-btn">
                        <button class="primary-btn group-btn_item" type="button" onclick="confirmOrder()"
                                data-tab-action="order">
                            Забронировать
                        </button>
                    </div>
                </div>
                ...
                <? if (count($arResult['MANAGER_LOCATIONS']) > 1): ?>
                    <input type="hidden" id="object-id" value="<?= $arResult['MANAGER_OBJECTS'][0]['ID'] ?>">
                <? endif; ?>
