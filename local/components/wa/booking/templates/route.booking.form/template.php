        ...
        <div class="booking-block">
            <div class="booking-block_info">
                ...
                <div class="modal-text">
                    <p>(согласно гл. VI п. 22 Положения о
                ...
                <div class="booking-block_btns">
                    ...
                    <button class="primary-btn primary-btn--lg primary-btn--disabled" type="button"
                            onclick="modalBookingShowForm('true')">Далее
                    </button>
                </div>
            ...
            <div class="booking-block_form">
                ...
                <? if ($arResult['LOCATION_DATA']): ?>
                    ...
                    <form action="" class="m-booking-form">
                        ...
                        <input type="hidden" value="true" name="IS_ROUTE">
                        <input type="hidden" value="<?= $arResult['LOCATION_DATA']['DAILY_TRAFFIC'] ?>"
                               name="DAILY_TRAFFIC">
                        ...
                        <div class="m-booking-form_bottom">
                            <div class="price">
                                ...
                                <div class="price_value"><span
                                            id="modal-booking-price"><?= $arResult['LOCATION_DATA']['OBJECT_COST'] ?></span> ₽
                                </div>
                            </div>
