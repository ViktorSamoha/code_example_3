...
<form action="" class="form-visiting-permit" id="add-user-group-element-form">
        ...
        <div class="form-block-w-dop-inputs js-show-dop-inputs">
            <div class="select-block hidden js-hidden-block">
                ...
                <div class="select-block dop-inputs_item hidden" data-id="<?= NATIVE_ID ?>">
                    ...
                    <div class="custom-select">
                        <div class="custom-select_head">
                            <span class="custom-select_title" id="user-location"></span>
                            <svg class="custom-select_icon" width="14" height="8" viewBox="0 0 14 8" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 1L7 7L13 1" stroke="#000"/>
                            </svg>
                ...
                <div class="input-group">
                    ...
                    <div class="input input--sm">
                        ...
                        <input type="text" class="input-date" name="U_PREF_DOC_DATE">
                    </div>
                ...
                <div class="input-file-wrap">
                    ...
                    <div class="input-file input-file--photo">
                        <input id="u-pref-docs" type="file" multiple data-id="U_PREF_DOCS"
                               accept=".png, .jpg, .jpeg, .pdf">
                        <label for="u-pref-docs">
    ...
    <div class="form-block">
        <div class="checkbox-list">
            <div class="checkbox">
                <input type="checkbox" id="checkbox_personal-data-confirm" required>
                <label for="checkbox_personal-data-confirm">
                    <div class="checkbox_text">Даю согласие на обработку персональных данных</div>
                </label>
            </div>
            <div class="checkbox">
                <input type="checkbox" id="checkbox_visiting-rules-confirm" required>
                <label for="checkbox_visiting-rules-confirm">
                    <div class="checkbox_text">Я согласен с правилами посещения территории нац. парка</div>
                </label>
            </div>
        </div>
    </div>
    <button class="primary-btn primary-btn--lg" id="add-user-group-element">Добавить</button>
    <br>
