            ...
            <table class="table">
                ...
                <? foreach ($arResult["ELEMENTS"] as $id => $item): ?>
                    <tr>
                        ...
                        <td><?= $item['CAPACITY_MAXIMUM'] ?></td>
                        <td>
                            <a href="/admin/objects_list/?EDIT=Y&OBJECT_ID=<?= $item['ID'] ?>" class="btn-edit">
                        ...
                        <td>
                            <a class="btn-remove" href="javascript:void(0)"
                               onclick="deleteObjectAction(<?= $item['ID'] ?>)">
