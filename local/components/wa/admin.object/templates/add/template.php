...
<form class="form-create-object" name="iblock_add">
    <input type="hidden" id="gallery-counter" value="0">
    <input type="hidden" id="video-preview-counter" value="0">
    ...
    <div class="form-block" id="object-prop-block">
        ...
        <div class="form-item">
            ...
            <div class="input-group"
                 id="price-block" style="display: none">
        ...
        <div class="form-item"
             id="work-time-node" style="display: none">
    ...
    <div class="form-block" id="route-prop-block" style="display: none">
        <h3 class="form-block_title">Краткие характеристики</h3>
        <div class="form-item">
            ...
            <div class="input-group">
                <div class="input input-lk-price">
                    <label for="">Стоимость суточного пребывания</label>
                    <input type="text" value="" name="OBJECT_COST">
                </div>
                <div class="input input-lk-price">
                    <label for="">Суточная посещаемость маршрута</label>
                    <input type="text" value="" name="DAILY_TRAFFIC">
                </div>
            </div>
        </div>
    </div>
    <input type="button" class="primary-btn primary-btn--xl" value="Сохранить" onclick="saveObject()">
    <input type="hidden" name="NORTHERN_LATITUDE" value=""
           id="object-n-l-coord"/>
    <input type="hidden" name="EASTERN_LONGITUDE" value=""
           id="object-e-l-coord"/>
    <input type="hidden" name="ROUTE_COORDS" value=""
           id="route-coords"/>
