...
<section class="modal" data-name="modal-admin-add-visitor">
    <div class="modal_block">
        ...
        <div class="edit_form js-parent-hidden-block">
            ...
            <form action="" class="m-edit" id="add-new-visitor">
                <input type="hidden" value="<?= $arParams['USER_RECORD_ID'] ?>" name="USER_RECORD_ID">
                <div class="form-visitor">
                    ...
                    <div class="form-block-w-dop-inputs js-show-dop-inputs">
                        ...
                        <div class="dop-inputs_item hidden"
                             data-id='21'>
                            ...
                            <div class="input-group">
                                ...
                                <div class="input input--sm">
                                    <label for="" class="input-label">Дата выдачи<span
                                                class="color-red">*</span></label>
                                    <input type="text" name="U_PREF_DOC_DATE" class="input-date js-input-date">
                                </div>
