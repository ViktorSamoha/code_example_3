...
<form action="" class="form-visiting-permit">
    ...
    <div class="form-block js-parent-hidden-block">
        ...
        <div class="input-group">
            ...
            <div class="input input--md">
                <label for="" class="input-label">Email<span class="color-red">*</span></label>
                <input type="text" name="EMAIL" required>
            </div>
        </div>
        <div class="checkbox-list">
            <div class="checkbox">
                <input type="checkbox" id="main-user-pref-category" class="js-switch-hidden-block">
                <label for="main-user-pref-category">
            ...
            <div class="select-block hidden js-hidden-block">
                ...
                <div class="custom-select">
                    <div class="custom-select_head">
                        <span class="custom-select_title" id="main-user-pref-category-select"></span>
                ...
                <div class="input-file-wrap">
                    ...
                    <div class="input-file input-file--photo">
                        <input id="u-pref-docs" type="file" multiple data-id="PREF_DOCS"
