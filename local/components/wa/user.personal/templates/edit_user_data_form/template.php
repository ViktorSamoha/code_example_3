...
<section class="modal active" data-name="modal-edit">
    <div class="modal_block">
        ...
        <div class="edit_form">
            <h2 class="modal_title">ЛИЧНЫЕ ДАННЫЕ</h2>
            <form action="" class="m-edit" id="user-edit-form">
                ...
                <div class="input-group">
                    <div class="input input--lg">
                        ...
                        <input type="text" value="<?= $arResult['USER_DATA']['LAST_NAME'] ?>" name="LAST_NAME"/>
                    </div>
                    <div class="input input--lg">
                        <label for="">Имя<span class="color-red">*</span></label>
                        <input type="text" value="<?= $arResult['USER_DATA']['NAME'] ?>" name="NAME"/>
                    </div>
                    <div class="input input--lg">
                        <label for="">Отчество</label>
                        <input type="text" value="<?= $arResult['USER_DATA']['SECOND_NAME'] ?>"
                               name="SECOND_NAME"/>
                    </div>
                    <div class="input input--md">
                        <label for="">E-mail</label>
                        <input type="email" value="<?= $arResult['USER_DATA']['EMAIL'] ?>" name="EMAIL"/>
                    </div>
                    <div class="input input--md">
                        <label for="">Телефон<span class="color-red">*</span></label>
                        <input type="tel" value="<?= $arResult['USER_DATA']['PHONE'] ?>" name="PHONE"/>
                    </div>
                </div>
                <div class="form-block js-parent-hidden-block">
                    <div class="checkbox-list">
                        <div class="checkbox">
                            <input type="checkbox" id="pref-category-checkbox"
                                   class="js-switch-hidden-block" <?= $arResult['USER_DATA']['PREF_CATEGORY'] ? 'checked' : '' ?>>
                    ...
                    <div class="form-block-w-dop-inputs js-show-dop-inputs">
                        <div class="select-block <?= $arResult['USER_DATA']['PREF_CATEGORY'] ? '' : 'hidden' ?> js-hidden-block">
                            ...
                            <div class="custom-select" id="user-edit-pref-select">
                                <div class="custom-select_head">
                                    <span class="custom-select_title"
                                          data-selected-id="<?= $arResult['USER_DATA']['PREF_CATEGORY']['ID'] ?>"><?= $arResult['USER_DATA']['PREF_CATEGORY']['VALUE'] ?></span>
                            ...
                            <div class="select-block dop-inputs_item <?= $arResult['USER_DATA']['PREF_CATEGORY']['ID'] == NATIVE_ID ? '' : 'hidden' ?>"
                                 data-id='<?=NATIVE_ID?>'>
                                ...
                                <div class="custom-select" id="user-edit-location-select">
                                    <div class="custom-select_head">
                                        <? if ($arResult['USER_DATA']['LOCATION']['VALUE']): ?>
                                            <span class="custom-select_title"
                                                  data-selected-id="<?= $arResult['USER_DATA']['LOCATION']['ID'] ?>"><?= $arResult['USER_DATA']['LOCATION']['VALUE'] ?></span>
                                        <? else: ?>
                            ...
                            <div class="input-group">
                                ...
                                <div class="input input--sm">
                                    <label for="" class="input-label">Дата выдачи<span
                                                class="color-red">*</span></label>
                                    <input type="text" class="input-date js-input-date c-doc-date" name="PREF_DOC_DATE"
                            ...
                            <div class="input-file-wrap">
                                ...
                                <div class="input-file input-file--photo">
                                    ...
                                    <? if (isset($arResult['USER_DATA']['USER_RECORD_DATA']['PREF_DOCS']) && !empty($arResult['USER_DATA']['USER_RECORD_DATA']['PREF_DOCS'])): ?>
                                        <input type="hidden" id="pref-docs-count"
                                               value="<?= count($arResult['USER_DATA']['USER_RECORD_DATA']['PREF_DOCS']) ?>">
                                        <? foreach ($arResult['USER_DATA']['USER_RECORD_DATA']['PREF_DOCS'] as $f_pos => $file): ?>
                                            <input type="file" name=PREF_DOCS_FVAL_<?= $f_pos ?>"
                                                   value="<?= $file ?>">
                                            <div class="input-file_preview active">
                                                <? if ($file['CONTENT_TYPE'] == "application/pdf"): ?>
                                                    <img src="/local/templates/.default/assets/img/default_doc_icon.svg"
                                                         alt="">
                                                <? else: ?>
                                                    <img src="<?= $file['SRC'] ?>" alt="">
                                                <? endif; ?>
                                                <button type="button" class="input-file-remove-btn"
                                                        data-property-id="PREF_DOCS"
